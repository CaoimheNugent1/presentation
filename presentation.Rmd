...
- We are combining to sets of data to create a table with the variables : sex, race, ethnic origin, age, year, n_persons (number of persons), median_weekly_earn (in dollars), industry, major occupation, minor occupation, industry total
...
---
#About data set 
further analysis required for merging data sets together
